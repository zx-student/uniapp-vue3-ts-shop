...
//uni-ui 弹出层ref， 组合式API获取ref方法，如果是选项式API中写法this.$refs.popup
const popup = ref<{
  // 指定了只有open和close的方法
...
<template>
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      ...
      <view class="preview">
        <swiper circular>
          <swiper-item v-for="item in goods?.mainPictures" :key="item" @change="onChange">
